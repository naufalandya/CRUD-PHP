        ...
        <div class="row my-2">
            <div class="col-md">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control w-50" id="class" value="<?= $students['class'];  ?>" name="class" autocomplete="off" required>
                </div>
                <div class="mb-3">
                    <label for="year" class="form-label">Jurusan</label>
